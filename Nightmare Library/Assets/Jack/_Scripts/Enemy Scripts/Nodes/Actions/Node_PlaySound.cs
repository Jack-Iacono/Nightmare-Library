...
public class Node_PlaySound : Node
{
    ...
    public Node_PlaySound(SoundType sound, Transform dynamicTarget)
    {
        soundType = sound;
        trans = dynamicTarget;
    ...
    public Node_PlaySound(SoundType sound, GetPositionDelegate targetPositionDelegate)
    {
        soundType = sound;
