...
public class Check_PlayerInSight : Node
{
    ...
    public Check_PlayerInSight(ActiveAttack owner, NavMeshAgent navAgent, float fovRange, float sightAngle)
    {
        this.owner = owner;
    ...
    public Check_PlayerInSight(ActiveAttack owner, NavMeshAgent navAgent, float fovRange, float sightAngle, Vector3 areaCenter, float areaRange, float sightBreakTime = 5)
    {
        this.owner = owner;
        this.navAgent = navAgent;
        transform = navAgent.transform;
